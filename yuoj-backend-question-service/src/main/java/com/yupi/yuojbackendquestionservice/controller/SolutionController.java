...
import com.yupi.yuojbackendcommon.constant.RedisConstant;
...
import com.yupi.yuojbackendmodel.model.dto.solution.SolutionActionRequest;
import com.yupi.yuojbackendmodel.model.dto.solution.SolutionAddRequest;
...
public class SolutionController {
    ...
    public BaseResponse<Boolean> updateViewCount(@RequestBody SolutionQueryRequest solutionQueryRequest,
                                                 HttpServletRequest request) {
        if (solutionQueryRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
     ...
     */
    @PostMapping("/like")
    public BaseResponse<Boolean> like(@RequestBody SolutionQueryRequest solutionQueryRequest,
                                      HttpServletRequest request) {
        if (solutionQueryRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
     ...
     */
    @PostMapping("/unlike")
    public BaseResponse<Boolean> unlike(@RequestBody SolutionQueryRequest solutionQueryRequest,
                                        HttpServletRequest request) {
        if (solutionQueryRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
    ...
    public BaseResponse<Boolean> isLiked(@PathVariable("solutionId") Long solutionId,
                                         HttpServletRequest request) {
        if (solutionId < 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
    ...
    public BaseResponse<Boolean> addFavorite(@RequestBody SolutionQueryRequest solutionQueryRequest,
                                             HttpServletRequest request) {
        if (solutionQueryRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
    ...
    public BaseResponse<Boolean> unFavorite(@RequestBody SolutionQueryRequest solutionQueryRequest,
                                            HttpServletRequest request) {
        if (solutionQueryRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
    ...
    public BaseResponse<Boolean> isFavorite(@PathVariable("solutionId") Long solutionId,
                                            HttpServletRequest request) {
        if (solutionId < 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
